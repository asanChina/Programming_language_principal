...
public class MyTestScanner {
	...
	// This test constructs the expected token list and compares to the one
	...
	//tests follow are create by me
	@Test
	public void twoConsecutiveKeywords(){
		System.out.println("two consecutive keywords");
		String input = "intstring";
		System.out.println(input);
		TokenStream stream = new TokenStream(input);
		Scanner scanner = new Scanner(stream);
		scanner.scan();
	...
	public void testStringLiteral(){
		System.out.println("test String literal");
		String input = "String a = \"pe\\\"hi\"";
		System.out.println(input);
		TokenStream stream = new TokenStream(input);
		Scanner scanner = new Scanner(stream);
		scanner.scan();
	...
	@Test
	public void testStringFromTestFile(){
		Reader reader = null;
		try{
			reader = new InputStreamReader(new FileInputStream(new File("testStringDeclaration.java")));
			System.out.println("test java String declaration from test file");
	...
	@Test
	public void testCommentFromTestFile(){
		Reader reader = null;
		try{
			reader = new InputStreamReader(new FileInputStream(new File("testComment.java")));
			System.out.println("test comment from test file");
			TokenStream stream = new TokenStream(reader);
			Scanner scanner = new Scanner(stream);
			scanner.scan();
			System.out.println(stream);
