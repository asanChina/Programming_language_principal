...
public class TestSymbolTable {
	...
	public void emptyTable() {
		System.out.println("========In empty table");
	...
	public void oneDecIdent() {
		System.out.println("========In oneDecIdent");
		SymbolTable symtab = new SymbolTable();
	...
	public void scope1(){
		...
		System.out.println(symtab.currentScope);
		assertNull(dec);
		assertFalse(symtab.insert("ident",new DummyDec("ident","ident")));
	}		
	
	@Test 
	public void scope2(){
		System.out.println("========In scope2");
		SymbolTable symtab = new SymbolTable();
		symtab.enterScope();
		assertTrue(symtab.insert("ident",new DummyDec("ident","ident")));
		Declaration dec = symtab.lookup("ident");
